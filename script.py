...
def mglg_default(user, skill):
    ...
    if 'F' in cell: r1, d1 = get_offset_between_cells('F47', 'I47')
    elif 'L' in cell: r1, d1 = get_offset_between_cells('L47', 'N47')
    elif 'Q' in cell: r1, d1 = get_offset_between_cells('Q47', 'S47')
    elif 'W' in cell:
        if '58' in cell:
            r1, d1 = get_offset_between_cells('W58', 'AQ58')
        else:
            r1, d1 = get_offset_between_cells('W47', 'AA47')
    elif 'AE' in cell: r1, d1 = get_offset_between_cells('AE47', 'AH47')
    elif 'AK' in cell: r1, d1 = get_offset_between_cells('AK47', 'AQ47')
